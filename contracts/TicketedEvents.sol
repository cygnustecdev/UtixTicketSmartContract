...
contract TicketedEvents is Ownable {
  ...
  //============================================================================
    ...
    constructor(string _name, string _location, string _symbol, uint256 _ticketsAvailable, uint256 _ticketPrice)
      public {
        name = _name;
        location = _location;
        symbol = _symbol;
  ...
  //============================================================================
    ...
    */
    function buyTicket(bytes32 _ticketToBuy) public payable  {
        ...
        emit NewTicketPurchaseEvent(msg.sender, newTicketId);
    }
  ...
  //============================================================================
    ...
    */
    function requestRefund(uint256 _ticketId) onlyOwnerOf(_ticketId) public returns (bool) {
        ...
        emit NewRefundRequestEvent(msg.sender, _ticketId); 
        return true; 
    }
    ...
    */
    function approveRefund(uint256 _ticketId) onlyOwner public returns (bool) {
        ...
        emit RefundRequestProcessedEvent(theBuyer, _ticketId);
        return true; 
    }
  ...
  //============================================================================
    ...
    */
    function approve(address _to, uint256 _ticketId) public onlyOwnerOf(_ticketId) {
        ...
        emit TicketTransferApprovalEvent(msg.sender, _to, _ticketId);
    }
    ...
    */
    function takeOwnership(uint256 _ticketId) public {
        ...
        emit TicketTransferCompletedEvent(msg.sender, _ticketId);
    }
